...
public class LinesTest {
	...
	public void testDrawLineEquation() {
		...
		Assert.assertEquals("Zeichnen mit Geradengleichung", expected, bufferedGraphics.toString());
	}
	...
	public void testDrawDda() {
		...
		Assert.assertEquals("Zeichnen mit DDA", expected, bufferedGraphics.toString());
	}
	...
	public void testDrawBresenham() {
		...
		Assert.assertEquals("Zeichnen mit Bresenham", expected, bufferedGraphics.toString());
	}
